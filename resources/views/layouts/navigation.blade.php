<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('vendas.dashboard')" :active="request()->routeIs('vendas.dashboard')">
                        {{ __('Vendas') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('atributos.index')" :active="request()->routeIs('atributos.*', 'valores.*')">
                        {{ __('Atributos') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('vendas.dashboard')" :active="request()->routeIs('vendas.dashboard')">
                {{ __('Vendas') }}
            </x-responsive-nav-link>
            ...
            <x-responsive-nav-link :href="route('atributos.index')" :active="request()->routeIs('atributos.*', 'valores.*')">
                {{ __('Atributos') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('estoque.movimentar')" :active="request()->routeIs('estoque.movimentar')">
                {{ __('Movimentar Estoque') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link :href="route('relatorios.movimentacoes')" :active="request()->routeIs('relatorios.movimentacoes')">
                {{ __('Relatórios') }}
            </x-responsive-nav-link>
