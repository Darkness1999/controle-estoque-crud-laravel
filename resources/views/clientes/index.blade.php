            ...
            <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <div class="mb-6 flex justify-between items-center">
                        <p class="font-xl text-lg font-semibold">Clientes Cadastrados</p>
                        ...
                        <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                            <thead class="bg-gray-100 dark:bg-gray-700">
                                <tr>
                                    ...
                                    <th class="px-6 py-3 text-left text-xs font-medium text-gray-600 dark:text-gray-300 uppercase tracking-wider">CPF/CNPJ</th>
                            ...
                            <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                @forelse ($clientes as $cliente)
                                    <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition">
                                        <td class="px-6 py-4 text-sm font-medium">{{ $cliente->nome }}</td>
                                        <td class="px-6 py-4 text-sm">{{ $cliente->cpf_cnpj }}</td>
                                        <td class="px-6 py-4 text-sm">{{ $cliente->email }}</td>
